...
down_revision: str | Sequence[str] | None = "3a0b796e2274"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_qa_pairs_project_id_created_at", "qa_pairs", ["project_id", "created_at"], unique=False
    )
    op.create_index(op.f("ix_qa_pairs_status"), "qa_pairs", ["status"], unique=False)
    op.create_index("ix_qa_pairs_tags", "qa_pairs", ["tags"], unique=False, postgresql_using="gin")
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        op.f("ix_projects_status_lease_expires_at"),
        "projects",
